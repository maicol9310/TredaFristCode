...
namespace TredaFront.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<JsonResult> ProductsJson()
        {
            ...
            var response = await httpClient.GetAsync("https://localhost:44313/api/Products");
        ...
        public async Task<ActionResult> AddProducts(Products products)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                using (var response = await httpClient.PostAsync("https://localhost:44313/api/Products", content))
                {
                    string apiResponse = await response.Content.ReadAsStringAsync();
