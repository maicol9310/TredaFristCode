...
namespace TredaFront.Controllers
{
    public class StoresController : Controller
    {
        ...
        public async Task<JsonResult> StoresJson()
        {
            ...
            var response = await httpClient.GetAsync("https://localhost:44313/api/Stores");
        ...
        public async Task<ActionResult> AddStore(Stores store)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                using (var response = await httpClient.PostAsync("https://localhost:44313/api/Stores", content))
                {
                    string apiResponse = await response.Content.ReadAsStringAsync();
